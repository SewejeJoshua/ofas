        ...
        <div className="flex flex-col-reverse lg:flex-row items-center gap-14 lg:gap-24 min-h-[85vh] py-16 lg:py-24 relative z-10">
          ...
          <div className="flex-1 text-center lg:text-left">
            ...
            <motion.h1
              ...
              className="text-4xl sm:text-5xl md:text-6xl xl:text-7xl font-semibold tracking-tight leading-[1.1] text-gray-900 dark:text-white"
            >
              {/* ✅ FIXED INLINE FLOW */}
              ...
              <span className="inline-block bg-gradient-to-r from-blue-400 to-sky-500 bg-clip-text text-transparent">
                Despite Asthma.
              </span>
            </motion.h1>
